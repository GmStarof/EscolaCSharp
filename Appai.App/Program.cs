                            ...
                            case "3":
                                {
                                    ...
                                    while (opcao == "1")
                                    {
                                        ...
                                        Aluno aluno = alunoService.localizarP(idAlun);
                                        ...
                                        else
                                        {
                                            ...
                                            Console.WriteLine("Deseja Cadastrar uma Materia ao Aluno: " + aluno.Nome + "? 1-SIM | 2-NÃO");
                                            ...
                                            if (opcao == "1")
                                            {
                                                ...
                                                Materia mate = materiaService.Localizar(idMat);
                                                if (mate == null)
                                                {
                                                ...
                                                {
                                                    if (alunoService.MateriaVerifica(aluno, idMat))
                                                    {
                                                        Console.WriteLine("Aluno já se encontra Com a Materia: " + mate.Nome);
                                                        Console.WriteLine("deseja verificar outro aluno? 1-SIM | 2-NÃO");
                                                        opcao = Console.ReadLine();
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        alunoService.CadastrarMateria(idAlun, mate);
                            ...
                            case "4":
                                {
                                    ...
                                    while (opcao == "1")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            Console.WriteLine("Deseja Cadastrar uma nota para a  Materia do Aluno: " + aluno.Nome + "? 1-SIM | 2-NÃO");
                                            ...
                                            if (opcao == "1")
                                            {
                                                ...
                                                aluno.Materia.ForEach(materias => Console.WriteLine("Materia: " + materias.Nome + " Id: " + materias.Id));
                                                ...
                                                else
                                                {
                                                    ...
                                                    alunoService.CadastrarNota(idAlun, mate, nota);
                            ...
                            case "3":
                                {
                                    ...
                                    while (opcao == "1")
                                    {
                                        ...
                                        Professor professor = professorService.localizarP(idProf);
                                        ...
                                        {
                                            if (professorService.MateriaVerifica(professor))
                                            {
                                                Console.WriteLine("Professor já se encontra Com uma Materia: " + professor.Materia.Nome + " !");
                                                Console.WriteLine("deseja verificar outro Professor? 1-SIM | 2-NÃO");
                                                opcao = Console.ReadLine();
                                            }
                                            else
                                            {
                                                Console.WriteLine("Deseja Cadastrar uma Materia ao Professor: " + professor.Nome + "? 1-SIM | 2-NÃO");
                                                ...
                                                if (opcao == "1")
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        professorService.CadastrarMateria(idProf, mate);
                            ...
                            case "3":
                                {
                                    ...
                                    while (opcao == "1")
                                    {
                                        ...
                                        Aluno aluno = alunoService.localizarP(id);
                                        ...
                                        {
                                            if (alunoService.StatusFinan(aluno))
                                            {
                            ...
                            case "4":
                                {
                                    ...
                                    while (opcao == "1")
                                    {
                                        ...
                                        Professor professor = professorService.localizarP(id);
                                        ...
                                        {
                                            if (professorService.StatusFinan(professor))
                                            {
